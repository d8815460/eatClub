...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        Parse.setApplicationId("ZTxP3OKo5rhzUL9U6HCU5mFUmRMLI0nyLDbebM9o", clientKey: "W9dRGkXMoeyUSGSa1CYPRmwyciXaLT6lhHGukoHC")
        //
...
//        PFFacebookUtils.session()?.close()
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "tw.com.eatClub" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("eatClub", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("eatClub.sqlite")
    ...
    func presentToHomePage () {
        ...
        destViewController = mainStoryboard.instantiateViewControllerWithIdentifier("root") as! UIViewController
